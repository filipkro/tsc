...
class Classifier_INCEPTION:
    ...
    #              nb_filters=4, use_residual=True, use_bottleneck=True, depth=3, kernel_size=13, nb_epochs=300):
    def __init__(self, output_directory, input_shape, nb_classes, verbose=False, build=True, batch_size=64, lr=0.001,
                 nb_filters=3, use_residual=True, use_bottleneck=True, depth=4, kernel_size=5, nb_epochs=1500):
