...
class Classifier_XCM:
    ...
    def build_model(self):
        ...
        output_layer = keras.layers.Dense(self.filters, activation='relu')(gap_layer)
        output_layer = keras.layers.Dense(self.filters, activation='relu', use_bias=False)(output_layer)
