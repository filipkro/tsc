...
def create_classifier(classifier_name, input_shape, nb_classes, output_directory, verbose=2):
    ...
    if classifier_name == 'coral-inception-mod':
        ...
        return coral_inception_mod.Classifier_INCEPTION(output_directory, input_shape, nb_classes, verbose, depth=2, nb_filters=128, kernel_size=41, nb_epochs=5000, bottleneck_size=32, use_residual=True, lr=0.001)
