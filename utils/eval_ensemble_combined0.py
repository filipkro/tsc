...
def main(args):
    ...
    if lit == 'Olga-Tokarczuk':
        ...
        models = ['conf-100-7000', 'coral-100-7000',
                  'xx-conf-100-7000', 'xx-conf-3020', 'xx-coral-100-5000', 'xx-coral-100-7000']
        weights = np.array([[0.15, 0, 0], [0.15, 1/3, 1/4],
                            [0.4, 0, 0], [0,0,1/4],[0.15, 1/3,1/4],[0.15,1/3,1/4]])
        ...
        # xx-conf-100-11000
        models = ['coral-100-7000', 'xx-coral-100-7000','xx-conf-100-7000','xx-conf-100-11000', 'xx-conf-9000']
        weights = np.array([[1/3,1/3,1/3],[1/3,1/3,1/3],[1/3,0,0],[0,0,1/3], [0,1/3,0]])

        models = ['coral-100-7000', 'xx-coral-100-7000','xx-conf-100-7000','xx-conf-100-11000', 'xx-conf-9000']
        weights = np.array([[1/3,1.25/3,1/3],[1/3,1.25/3,1/3],[1/3,0,0],[0,0,1/3], [0,1.25/3,0]])
        weights = np.array([[1/3,1.25/3,1/3],[1/3,1.25/3,1/3],[1/3,0,0],[0,0,1/3], [0,1.25/3,0]])
        ...
        models = ['coral-100-3100', 'coral-3100', 'xx-conf-100-3100', 'xx-coral-100-3100',
                  'conf-100-12000']
        weights = np.array([[1/3, 1/3, 1/3], [1/3, 1/3, 1/3], [1/3, 0, 0],
                            [0, 0, 1/3], [0, 1/3, 0]])

        models = ['coral-100-3100', 'coral-3100', 'xx-conf-100-3100', 'xx-coral-100-3100',
                  'conf-100-12000']
        weights = np.array([[1/3, 1.15/3, 1/3], [1/3, 1.15/3, 1/3], [1/3, 0, 0],
                            [0, 0, 1/3], [0, 1.15/3, 0]])
        ...
        weights = np.array([[1/4,1.05/4,1.5/4],[1/4,1.05/4,1.5/4],[1/2,0,0], [0,1.05/2,0], [0,0,1.5/2]])
        ...
        weights = np.array([[0, 0.2, 0], [0.2, 0.2, 0.1], [0, 0, 0.1], [0.4, 0, 0],
                            [0, 0.2, 0], [0,0,0.1], [0.2,0.2,0.1], [0.2,0.2,0.1]])
        models = ['inception-3010', 'xx-conf-100-3015', 'xx-conf-3010', 'conf-100-13000', 'xx-conf-3025']
        weights = np.array([[0.5, 1.05*0.5, 1/3], [0, 0, 1/3], [0.5, 0, 0],
                            [0, 1.05*0.5, 0], [0,0,1/3]])
        models = ['inception-3010', 'xx-inception-3010', 'xx-conf-3010', 'conf-100-13000', 'xx-conf-3025']
        weights = np.array([[1/3, 1.25*1/3, 1.25/3],[1/3, 1.25*1/3, 1.25/3], [1/3, 0, 0],
        ...
        weights = np.array([[1/3,1.15/3,1/3], [1/3,1.15/3,1/3],[1/3,0,0],[0,1.15/3,0],[0,0,1/3]])
    ...
    for fold in range(1, num_folds + 1):
        ...
        # ensemble_probs = (ensemble_probs > 0.15) * ensemble_probs
        # lower_idx = np.where(ensemble_probs < 0.2)[0]
        # for i in lower_idx:
        #     # print(i)
        #     ensemble_probs[i] = 0
        ...
        for i in idx['val_idx']:
            ...
            # print(f'correct: {y[i]}, predicted class: {predicted_class}, prob: {ensemble_probs[i, predicted_class]}')
